...
class Interferometer(object):
    ...
    def get_detector_response(self, waveform_polarizations, parameters, frequencies=None):
        ...
        # Transform linear polarizations to circular polarizations
        waveform_polarizations_circular = {}
        waveform_polarizations_circular['left'] = (waveform_polarizations['plus'] - (waveform_polarizations['cross'] * 1j)) / np.sqrt(2)
        ...
        waveform_polarizations_circular['left'] *= np.exp((luminosity_distance_to_comoving_distance(parameters['luminosity_distance'])/1000) * parameters['kappa'] * (frequencies / 100))
        waveform_polarizations_circular['right'] *= np.exp(-1 * (luminosity_distance_to_comoving_distance(parameters['luminosity_distance'])/1000) * parameters['kappa'] * (frequencies / 100)) 
        ...
        waveform_polarizations['cross'] = ((waveform_polarizations_circular['right'] - waveform_polarizations_circular['left']) * np.sqrt(2)) / 2j
